...
db.version(1).stores({ images: "++id, tierlistId, dateAdded, fileName", tierlists: "++id, status, date", items: ", id, name, resides, tierlistId, [tierlistId+resides], [tierlistId+name], [id+tierlistId]"});
